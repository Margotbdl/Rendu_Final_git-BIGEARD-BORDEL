...
DATA_FILE1  = os.path.expanduser('~/project_data/crypto_pools_extended.csv')   # Project 1 (<72h pools)
DATA_FILE2  = os.path.expanduser('~/project_data/crypto_pools_biggest.csv')    # Project 2 (biggest pools)
PRICES_FILE = os.path.expanduser('~/project_data/crypto_prices.csv')           # Project 3 (crypto prices)
...
def update_dashboard(n_intervals,
    ...
    if not df2.empty:
        ...
        # Biggest Pools: on prend le dernier enregistrement par pool
    ...
    if os.path.exists(today_report_path):
        ...
        report_text = "No report available for today yet."
